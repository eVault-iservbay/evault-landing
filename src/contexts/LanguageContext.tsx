...
const translations = {
  ...
  es: {
    ...
    addressPlaceholder:
      "Avenida de Negocios 123, Suite 100, Ciudad, Estado 12345",
  },
  fr: {
    home: "Accueil",
    about: "À Propos",
